            ...
            <div class="panel-body" >
                <form method="post">
                    ...
                    <div id="div_id_productname" class="form-group required">
                        <label for="id_clientname" class="control-label col-md-4  requiredField">Product Name<span class="asteriskField">*</span> </label>
                        <div class="controls col-md-8 ">
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="controls col-md-8 ">
                            <input type="submit" name="submitclient" value="Submit" class="btn btn-primary btn btn-info" id="submit-id-addproduct" />
                            <input type="reset" name="resetclient" value="Reset" class="btn btn-danger btn btn-info" id="reset-id-addproduct" />
                        </div>
                    </div> 
